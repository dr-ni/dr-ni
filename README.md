...
- 🧮 Misc utilities: [helmert3d](https://github.com/dr-ni/helmert3d) (3D Helmert transformation for geodesy), [ipa2arpabet](https://github.com/dr-ni/ipa2arpabet) (IPA → CMU ARPAbet translator)

📫 Reach me via GitHub issues on any of the repos above.

<!--
📌 To make this appear on your GitHub profile page (like DimStar77's does):
1. Create a new PUBLIC repository named exactly "dr-ni" (must match your username).
2. Add this file as README.md in that repo's root.
3. GitHub will automatically render it at the top of https://github.com/dr-ni
-->
